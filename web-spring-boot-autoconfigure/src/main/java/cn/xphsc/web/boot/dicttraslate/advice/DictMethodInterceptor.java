 ...
 * @description: Core interceptor of Dict
 * @since 1.0.0
 */
public class DictMethodInterceptor implements MethodInterceptor{

   public DictMethodInterceptor(){
  }
    ...
    public Object invoke(MethodInvocation methodInvocation) throws Throwable {
        ...
        obj= dictTranslationBuilder.dictTransResult(methodInvocation.proceed(),methodInvocation.getMethod(),false);
        return obj;
    }
}
