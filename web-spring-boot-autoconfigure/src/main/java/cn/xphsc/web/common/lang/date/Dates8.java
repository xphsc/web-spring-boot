...
public class Dates8 {
    ...
    private static final Map<String, DateTimeFormatter> DATE_TIME_FORMAT_CONTAINER = new ConcurrentReferenceHashMap<>(Constants.CAPACITY_16, ConcurrentReferenceHashMap.ReferenceType.SOFT);

    private Dates8() {
    }

    static {
        DATE_TIME_FORMAT_CONTAINER.put(DatesFormat.YMD, DateTimeFormatter.ofPattern(DatesFormat.YMD));
        DATE_TIME_FORMAT_CONTAINER.put(DatesFormat.YMD_HMS, DateTimeFormatter.ofPattern(DatesFormat.YMD_HMS));
    }
    ...
    public static Instant instant(LocalDate d) {
        return d.atStartOfDay().toInstant(DatesFormat.DEFAULT_ZERO_ZONE_OFFSET);
    }
    ...
    public static Instant instant(LocalDateTime dt) {
        return dt.toInstant(DatesFormat.DEFAULT_ZONE_OFFSET);
    }
    ...
    public static long timestamp() {
        return System.currentTimeMillis() / DatesFormat.SECOND_STAMP;
    }

    public static long timestamp(Date date) {
        return date.getTime() / DatesFormat.SECOND_STAMP;
    }
    ...
    public static long timestamp(LocalDate d) {
        return d.atStartOfDay().toInstant(DatesFormat.DEFAULT_ZERO_ZONE_OFFSET).getEpochSecond();
    }

    public static long timestamp(LocalDate d, ZoneOffset offset) {
        return d.atStartOfDay().toInstant(offset).toEpochMilli() / DatesFormat.SECOND_STAMP;
    }

    public static long timestamp(LocalDateTime d) {
        return d.toEpochSecond(DatesFormat.DEFAULT_ZONE_OFFSET);
    }
    ...
    public static Date date(LocalDate d) {
        return Date.from(d.atStartOfDay().toInstant(DatesFormat.DEFAULT_ZONE_OFFSET));
    }
    ...
    public static Date date(LocalDateTime d) {
        return Date.from(d.atZone(DatesFormat.DEFAULT_ZONE_OFFSET).toInstant());
    }
    ...
    public static LocalDate localDate(long ms) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, 0, DatesFormat.DEFAULT_ZONE_OFFSET).toLocalDate();
    }

    public static LocalDate localDate(long ms, ZoneOffset offset) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, 0, offset).toLocalDate();
    }

    public static LocalDate localDate(Date date) {
        return LocalDateTime.ofInstant(date.toInstant(), DatesFormat.DEFAULT_ZONE_ID).toLocalDate();
    }
    ...
    public static LocalDate localDate(Instant instant) {
        return LocalDateTime.ofInstant(instant, DatesFormat.DEFAULT_ZONE_ID).toLocalDate();
    }
    ...
    public static LocalTime localTime(long ms, int nano) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, nano, DatesFormat.DEFAULT_ZONE_OFFSET).toLocalTime();
    }

    public static LocalTime localTime(long ms, int nano, ZoneOffset offset) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, nano, offset).toLocalTime();
    }

    public static LocalTime localTime(long ms) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, 0, DatesFormat.DEFAULT_ZONE_OFFSET).toLocalTime();
    }

    public static LocalTime localTime(long ms, ZoneOffset offset) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, 0, offset).toLocalTime();
    }

    public static LocalTime localTime(Date date) {
        return LocalDateTime.ofInstant(date.toInstant(), DatesFormat.DEFAULT_ZONE_ID).toLocalTime();
    }
    ...
    public static LocalTime localTime(Instant instant) {
        return LocalDateTime.ofInstant(instant, DatesFormat.DEFAULT_ZONE_ID).toLocalTime();
    }
    ...
    public static LocalDateTime localDateTime(long ms) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, 0, DatesFormat.DEFAULT_ZONE_OFFSET);
    }

    public static LocalDateTime localDateTime(long ms, ZoneOffset offset) {
        return LocalDateTime.ofEpochSecond(ms / DatesFormat.SECOND_STAMP, 0, offset);
    }

    public static LocalDateTime localDateTime(Date date) {
        return LocalDateTime.ofInstant(date.toInstant(), DatesFormat.DEFAULT_ZONE_ID);
    }
    ...
    public static LocalDateTime localDateTime(Instant instant) {
        return LocalDateTime.ofInstant(instant, DatesFormat.DEFAULT_ZONE_ID);
    }
    ...
    public static String format(TemporalAccessor d) {
        return format(d, DatesFormat.YMD_HMS);
    }
    ...
    public static TemporalAccessor parse(String d) {
        ...
        String pattern = null;
        if (d.contains("-")) {
            for (String s : DatesFormat.PARSE_PATTERN_GROUP1) {
            ...
            for (String s : DatesFormat.PARSE_PATTERN_GROUP2) {
                if (d.length() == s.length()) {
                    pattern = s;
                    break;
                }
            ...
            for (String s : DatesFormat.PARSE_PATTERN_GROUP3) {
                if (d.length() == s.length()) {
                    pattern = s;
                    break;
                }
