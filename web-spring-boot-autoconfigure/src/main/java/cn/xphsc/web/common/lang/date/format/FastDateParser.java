...
import cn.xphsc.web.common.exception.ParseDateException;
    ...
    public Date parse(String source) {
        ...
        if (date == null) {
            ...
            if (locale.equals(JAPANESE_IMPERIAL)) {
                throw new ParseDateException("(the " + locale + " locale does not support dates before 1868 AD)\n" +
                        "unParse date: \"" + source + " " + pp.getErrorIndex());
            }
            throw new ParseDateException("unparsed date: " + source + " " + pp.getErrorIndex());
        }
        return date;
    }
