...
public class Files {
    ...
    public static boolean isExecutable(Path file) {
        return java.nio.file.Files.isExecutable(file);
    }
    ...
    public static boolean isReadable(Path file) {
        return java.nio.file.Files.isReadable(file);
    }
    ...
    public static boolean isWritable(Path file) {
        return java.nio.file.Files.isWritable(file);
    }
    ...
    public static boolean isHidden(Path file) {
        try {
            return java.nio.file.Files.isHidden(file);
        } catch (IOException e) {
    ...
    public static boolean isSymbolicLink(String file) {
        return java.nio.file.Files.isSymbolicLink(Paths.get(file));
    }

    public static boolean isSymbolicLink(File file) {
        return java.nio.file.Files.isSymbolicLink(Paths.get(file.getAbsolutePath()));
    }
    ...
    public static Path getSymbolicLink(String file) {
        try {
            return java.nio.file.Files.readSymbolicLink(Paths.get(file));
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public static File getSymbolicLink(File file) {
        try {
            return java.nio.file.Files.readSymbolicLink(Paths.get(file.getAbsolutePath())).toFile();
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public static Path getSymbolicLink(Path file) {
        try {
            return java.nio.file.Files.readSymbolicLink(file);
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public static boolean createLink(Path source, Path link) {
        try {
            java.nio.file.Files.createDirectories(link.getParent());
            java.nio.file.Files.createLink(link, source);
            return true;
        } catch (IOException e) {
            return false;
        }
    ...
    public static boolean createSymbolLink(Path source, Path link) {
        try {
            java.nio.file.Files.createDirectories(link.getParent());
            java.nio.file.Files.createSymbolicLink(link, source);
            return true;
        } catch (IOException e) {
            return false;
        }
    ...
    public static String getOwner(Path file) {
        try {
            return java.nio.file.Files.getOwner(file).getName();
        } catch (IOException e) {
            throw Exceptions.runtime(e);
        }
    }
    ...
    public static String getSize(long size) {
        ...
        return NumberUtils.setScale(s, 1) + unit;
    }
    ...
    public static String streamToFile(InputStreamReader reader, File file, String charset) {
        ...
        try {
            ...
            char[] cs = new char[Constants.BUFFER_KB_8];
            int read;
    ...
    public static String streamToFile(InputStream in, File file) {
        ...
        try (OutputStream out = openOutputStream(file)) {
            byte[] bs = new byte[Constants.BUFFER_KB_8];
            int read;
    ...
    public static void mergeFile(List<File> sources, File target) {
        ...
        try {
            for (File source : sources) {
                ...
                byte[] bytes = new byte[Constants.BUFFER_KB_8];
                int read;
    ...
    public static void copy(File source, File target) {
        try (FileChannel inc = openInputStream(source).getChannel();
            ...
            ByteBuffer buffer = ByteBuffer.allocate(Constants.BUFFER_KB_8);
    ...
    public static String getTempFilePath() {
        return Systems.HOME_DIR + IO_TEMP_DIR + UUID.random32() + ".temp";
    }
    ...
    public static boolean mv(Path file, Path target) {
        try {
            java.nio.file.Files.move(file, target);
            return true;
        } catch (IOException e) {
            return false;
        }
    ...
    public static boolean mv(Path file, String name) {
        try {
            java.nio.file.Files.move(file, file.getParent().resolve(name));
            return true;
        } catch (IOException e) {
            return false;
        }
    ...
    public static boolean deleteDir(Path path) {
        ...
        try {
            java.nio.file.Files.list(path).forEach(f -> {
    ...
    public static String getFileLineSeparator(File file) {
        ...
        try {
            r = new RandomAccessFile(file, Constants.ACCESS_R);
    ...
    public static String getFileEndLineSeparator(File file) {
        try (RandomAccessFile r = new RandomAccessFile(file, Constants.ACCESS_R)) {
            long length = r.length();
            if (length == 0) {
                return Constants.LF;
            } else if (length >= 2) {
    ...
    public static OutputStream openOutputStreamFast(Path file, boolean append) throws IOException {
        if (java.nio.file.Files.exists(file)) {
            ...
            if (!java.nio.file.Files.isWritable(file)) {
                throw Exceptions.io("file '" + file + "' cannot be written to");
            }
        } else {
        ...
        if (append) {
            return java.nio.file.Files.newOutputStream(file, StandardOpenOption.APPEND);
        } else {
            return java.nio.file.Files.newOutputStream(file);
        }
    }
    ...
    public static String omitPath(String path, int length) {
        return omitPath(path, length, Constants.OMIT);
    }
    ...
    public static int permission10to8(int permission) {
        return Integer.parseInt(new BigInteger(permission + StringUtils.EMPTY, 8).toString(10));
    }
    ...
    public static int permission8to10(int permission) {
        return Integer.parseInt(new BigInteger(permission + StringUtils.EMPTY, 10).toString(8));
    }
    ...
    public static String permission10toString(int permission) {
        ...
        for (char c : chars) {
            int per = Integer.parseInt(c + StringUtils.EMPTY);
            if ((per & 4) == 0) {
                sb.append('-');
            } else {
                sb.append('r');
