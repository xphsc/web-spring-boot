...
import cn.xphsc.web.common.collect.mutable.MutableHashMap;
import cn.xphsc.web.common.lang.constant.Constants;
import cn.xphsc.web.common.lang.io.Streams;
import cn.xphsc.web.common.lang.mutable.MutableString;
...
public class Urls {
    ...
    public static String buildQueryString(Map<String, ?> request) {
        return queryString(request, null, false, null);
    }
     ...
     * @return url
     */
    public static String queryString(Map<String, ?> request, boolean encode) {
        return queryString(request, null, encode, null);
    }
     ...
     * @return url
     */
    public static String queryString(Map<String, ?> request, boolean encode, String encodeCharset) {
        return queryString(request, null, encode, encodeCharset);
    }
     ...
     * @return url
     */
    public static String queryString(Map<String, ?> request, List<String> skipFields) {
        return queryString(request, skipFields, false, null);
    }
     ...
     * @return url
     */
    public static String queryString(Map<String, ?> request, List<String> skipFields, boolean encode) {
        return queryString(request, skipFields, encode, null);
    }
     ...
     * @return url
     */
    public static String queryString(Map<String, ?> request, List<String> skipFields, boolean encode, String encodeCharset) {
    ...
    public static String decode(String url) {
        return decode(url, Constants.UTF_8);
    }
    ...
    public static class UrlStream {
        ...
        private void setProtocolPort() {
            ...
            if (Constants.PROTOCOL_HTTP.equals(this.protocol)) {
                this.port = 80;
            } else if (Constants.PROTOCOL_HTTPS.equals(this.protocol)) {
                this.port = 443;
            } else if (Constants.PROTOCOL_FTP.equals(this.protocol)) {
                this.port = 21;
            } else if (Constants.PROTOCOL_SSH.equals(this.protocol)) {
                this.port = 22;
            }
        }
