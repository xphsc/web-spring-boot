...
public class ConvertTypes {
    ...
    public static <T, R> R to(T t, Class<R> targetClass) {
        return ObjectTypeStore.STORE.to(t, targetClass);
    }

    public static <T, R> ConvertFunction<T, R> to(Class<R> targetClass) {
     ...
     * @return 新值
     */
    public static <T, R> R to(T t, ConvertFunction<T, R> f) {
        return f.apply(t);
    }
    ...
    public static Date toDate(Object o) {
        ...
        if (date == null) {
            throw new RuntimeException(StringUtils.format("unable to convert [{}: {}] to [Date]", o.getClass().getName(), o.toString()));
        }
        return date;
    }
    ...
    public static LocalDate toLocalDate(Object o) {
        ...
        if (date == null) {
            throw new RuntimeException(StringUtils.format("unable to convert [{}: {}] to [LocalDate]", o.getClass().getName(), o.toString()));
        }
        return date;
    }
    ...
    public static LocalDateTime toLocalDateTime(Object o) {
        ...
        if (date == null) {
            throw new RuntimeException(StringUtils.format("unable to convert [{}: {}] to [LocalDateTime]", o.getClass().getName(), o.toString()));
        }
        return date;
    }
    ...
    public static byte toByte(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [byte]", o.getClass().getName()));
    }
    ...
    public static short toShort(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [short]", o.getClass().getName()));
    }
    ...
    public static int toInt(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [int]", o.getClass().getName()));
    }
    ...
    public static long toLong(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [long]", o.getClass().getName()));
    }
    ...
    public static float toFloat(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [float]", o.getClass().getName()));
    }
    ...
    public static double toDouble(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [double]", o.getClass().getName()));
    }
    ...
    public static boolean toBoolean(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [boolean]", o.getClass().getName()));
    }
    ...
    public static char toChar(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [char]", o.getClass().getName()));
    }
    ...
    public static String[] toStrings(Object o) {
        ...
        throw new RuntimeException(StringUtils.format("unable to convert [{}] to [String[]]", o.getClass().getName()));
    }
