 ...
 * @since 2.0.1
 */
@Plugin(name = "log4jSensitivePatternLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class Log4jSensitivePatternLayout extends AbstractStringLayout {
     ...
     */
    private Log4jSensitivePatternLayout(final Configuration config, final Log4jSensitivePatternReplaces replace, final String eventPattern,
    ...
    public static Serializer createSerializer(final Configuration configuration, final Log4jSensitivePatternReplaces replace,
        ...
        if (patternSelector == null) {
            try {
                ...
                return new Log4jSensitivePatternLayout.PatternSerializer(formatters, replace);
            } catch (final RuntimeException ex) {
                throw new IllegalArgumentException("Cannot parse pattern '" + pattern + "'", ex);
            }
        }
        return new Log4jSensitivePatternLayout.PatternSelectorSerializer(patternSelector, replace);
    }
     ...
     */
    @PluginFactory
    public static Log4jSensitivePatternLayout createLayout(
     ...
     */
    public static Log4jSensitivePatternLayout createDefaultLayout() {
     ...
     * @see #DEFAULT_CONVERSION_PATTERN Default conversion pattern
     */
    public static Log4jSensitivePatternLayout createDefaultLayout(final Configuration configuration) {
    ...
    public static Log4jSensitivePatternLayout.Builder newBuilder() {
        return new Log4jSensitivePatternLayout.Builder();
    }

    /**
     * Custom PatternLayout builder. Use the {@link PatternLayout#newBuilder() builder factory method} to create this.
     */
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<Log4jSensitivePatternLayout> {
        ...
        @PluginElement("log4jSensitivePatternReplaces")
        ...
        public Log4jSensitivePatternLayout.Builder withPattern(final String pattern) {
            this.pattern = pattern;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withPatternSelector(final PatternSelector patternSelector) {
            this.patternSelector = patternSelector;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withConfiguration(final Configuration configuration) {
            this.configuration = configuration;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withRegexReplacement(final Log4jSensitivePatternReplaces regexReplacement) {
            this.regexReplacement = regexReplacement;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withCharset(final Charset charset) {
        ...
        public Log4jSensitivePatternLayout.Builder withAlwaysWriteExceptions(final boolean alwaysWriteExceptions) {
            this.alwaysWriteExceptions = alwaysWriteExceptions;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withNoConsoleNoAnsi(final boolean noConsoleNoAnsi) {
            this.noConsoleNoAnsi = noConsoleNoAnsi;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withHeader(final String header) {
            this.header = header;
            return this;
        }

        public Log4jSensitivePatternLayout.Builder withFooter(final String footer) {
            this.footer = footer;
            return this;
        }

        @Override
        public Log4jSensitivePatternLayout build() {
            if (configuration == null) {
                configuration = new DefaultConfiguration();
            }
            return new Log4jSensitivePatternLayout(configuration, regexReplacement, pattern, patternSelector, charset,
