 ...
 */
package cn.xphsc.web.logger.log4j.sensitive;


import cn.xphsc.web.logger.log4j.Log4jSensitivePatternReplaces;
 ...
 * @since 2.0.1
 */
@Plugin(name = "log4jSensitivePatternLayoutEncoder", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class Log4jSensitivePatternLayoutEncoder extends AbstractStringLayout {
     ...
     */
    private Log4jSensitivePatternLayoutEncoder(final Configuration config, final Log4jSensitivePatternReplaces replace, final String eventPattern,
    ...
    public static Serializer createSerializer(final Configuration configuration, final Log4jSensitivePatternReplaces replace,
        ...
        if (patternSelector == null) {
            try {
                ...
                return new Log4jSensitivePatternLayoutEncoder.PatternSerializer(formatters, replace);
            } catch (final RuntimeException ex) {
                throw new IllegalArgumentException("Cannot parse pattern '" + pattern + "'", ex);
            }
        }
        return new Log4jSensitivePatternLayoutEncoder.PatternSelectorSerializer(patternSelector, replace);
    }
     ...
     */
    @PluginFactory
    public static Log4jSensitivePatternLayoutEncoder createLayout(
            ...
            @PluginElement("log4jSensitivePatternReplaces") final Log4jSensitivePatternReplaces replace,
    ...
    private static class PatternSerializer implements Serializer, Serializer2 {
        ...
        private final Log4jSensitivePatternReplaces replace;

        private PatternSerializer(final PatternFormatter[] formatters, final Log4jSensitivePatternReplaces replace) {
            super();
    ...
    private static class PatternSelectorSerializer implements Serializer, Serializer2 {
        ...
        private PatternSelectorSerializer(final PatternSelector patternSelector, final Log4jSensitivePatternReplaces replace) {
            super();
            this.patternSelector = patternSelector;
            this.replace = replace;
        }
     ...
     */
    public static Log4jSensitivePatternLayoutEncoder createDefaultLayout() {
     ...
     * @see #DEFAULT_CONVERSION_PATTERN Default conversion pattern
     */
    public static Log4jSensitivePatternLayoutEncoder createDefaultLayout(final Configuration configuration) {
    ...
    public static Log4jSensitivePatternLayoutEncoder.Builder newBuilder() {
        return new Log4jSensitivePatternLayoutEncoder.Builder();
    }

    /**
     * Custom PatternLayout builder. Use the {@link PatternLayout#newBuilder() builder factory method} to create this.
     */
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<Log4jSensitivePatternLayoutEncoder> {
        ...
        private Log4jSensitivePatternReplaces regexReplacement;
        ...
        public Log4jSensitivePatternLayoutEncoder.Builder withPattern(final String pattern) {
            this.pattern = pattern;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withPatternSelector(final PatternSelector patternSelector) {
            this.patternSelector = patternSelector;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withConfiguration(final Configuration configuration) {
            this.configuration = configuration;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withRegexReplacement(final Log4jSensitivePatternReplaces regexReplacement) {
            this.regexReplacement = regexReplacement;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withCharset(final Charset charset) {
        ...
        public Log4jSensitivePatternLayoutEncoder.Builder withAlwaysWriteExceptions(final boolean alwaysWriteExceptions) {
            this.alwaysWriteExceptions = alwaysWriteExceptions;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withNoConsoleNoAnsi(final boolean noConsoleNoAnsi) {
            this.noConsoleNoAnsi = noConsoleNoAnsi;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withHeader(final String header) {
            this.header = header;
            return this;
        }

        public Log4jSensitivePatternLayoutEncoder.Builder withFooter(final String footer) {
            this.footer = footer;
            return this;
        }

        @Override
        public Log4jSensitivePatternLayoutEncoder build() {
            if (configuration == null) {
                configuration = new DefaultConfiguration();
            }
            return new Log4jSensitivePatternLayoutEncoder(configuration, regexReplacement, pattern, patternSelector, charset,
